...
<style>
    ...
    [data-testid="stFileUploader"] p, [data-testid="stFileUploader"] small, [data-testid="stFileUploader"] span { color: #888 !important; }
...
DISEASE_INFO = {
    ...
    'Tomato Mosaic Virus': "Virus menyebar via kontak atau alat. Daun bermotif mosaik, bergelombang. Buang tanaman terinfensi, disinfeksi alat.",
    'Healthy': "Tanaman tomat Anda <b>sehat!</b> Pertahankan praktik perawatan yang baik.",
}

# Perbarui warna Top-3 menjadi palet monokromatik abu-abu yang minimalis
...
if uploaded_file is not None:
    ...
    # Redupkan warna aksen isian progress bar
    bar_color  = "#37a66b" if is_healthy else "#c0392b"
    ...
    for rank, idx in enumerate(top3):
        ...
        # Gunakan palet monokromatik abu-abu yang minimalis
